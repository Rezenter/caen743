...
1. Запрос готовности.  
    {'cmd': 'alive'}  
В случае готовности системы к работе ответ приходит в виде:
    {'cmd': 'alive', 'status': True}

->{"cmd": "arm", "shotn": 81, "isPlasma": false}  
<-{'id': 1, 'response': True, 'status': True}

->{"cmd": "disarm"}  
<-{'id': 2, 'response': True, 'status': True}
